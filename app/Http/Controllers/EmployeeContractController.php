...
class EmployeeContractController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employee-contract.index', compact('contracts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('employee-contract.index')->with('success', 'Kontrak berhasil ditambahkan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('employee-contract.index')->with('success', 'Kontrak berhasil diperbarui');
    }
